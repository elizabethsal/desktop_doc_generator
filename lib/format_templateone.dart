...
void main() async {
  final f = File("/home/daria/Dev/Flutter/desktop_doc_generator/lib/template.docx");
  final docx = await DocxTemplate.fromBytes(await f.readAsBytes());


  // Load test image for inserting in docx
  final testFileContent = await File("/home/daria/Dev/Flutter/desktop_doc_generator/lib/20230420_152717.jpg").readAsBytes();
  final listNormal = [FIOCHILD, DATEOFBIRTH, GROUPSTSPEC];
  final listBold = [HEADER, RESULTSPSIX, STATEOFMOTORSPHERE];
  ...
  final fileGenerated = File('generate.docx');
